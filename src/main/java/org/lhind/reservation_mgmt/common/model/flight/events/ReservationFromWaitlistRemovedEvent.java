 ...
 *
 */
public class ReservationFromWaitlistRemovedEvent extends
  ...
  public static final EventType EVENT_TYPE = new EventType(
      "ReservationFromWaitlistRemovedEvent");

  public ReservationFromWaitlistRemovedEvent(FlightId flightId,
