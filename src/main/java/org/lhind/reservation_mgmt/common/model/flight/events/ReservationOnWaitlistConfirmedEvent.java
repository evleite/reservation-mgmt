 ...
 *
 */
public class ReservationOnWaitlistConfirmedEvent extends
  ...
  public static final EventType EVENT_TYPE = new EventType(
      "ReservationOnWaitlistConfirmedEvent");

  public ReservationOnWaitlistConfirmedEvent(FlightId flightId,
